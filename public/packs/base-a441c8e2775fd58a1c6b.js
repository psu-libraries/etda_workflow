...
__webpack_require__(/*! jquery-ujs */ 24);
__webpack_require__(/*! bootstrap-modal */ 25);
__webpack_require__(/*! bootstrap3 */ 26);
__webpack_require__(/*! ../styles/base/_base.scss */ 6);
__webpack_require__(/*! ../base/ldap_lookup.js */ 39);
__webpack_require__(/*! ../base/alerts.js */ 40);
__webpack_require__(/*! ../base/collapse_indicators.js */ 41);
__webpack_require__(/*! ../base/display_first_nested_field.js */ 42);
__webpack_require__(/*! ../base/layout.js */ 43);
__webpack_require__(/*! ../base/tagit.js */ 44);
__webpack_require__(/*! ../base/toggle_caret.js */ 45);

__webpack_require__(/*! ../images/PS_HOR_REV_RGB_2C.png */ 46);
...
/* 25 */
/*!***********************************************!*\
  !*** ./node_modules/bootstrap-modal/index.js ***!
  \***********************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
/* 39 */
/*!********************************************!*\
  !*** ./app/javascript/base/ldap_lookup.js ***!
  \********************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
initialize_ldap_autocomplete = function initialize_ldap_autocomplete() {
    var input_fields = $('input.ldap-lookup');
...
initialize_addon_autocomplete = function initialize_addon_autocomplete() {
    return $('#add_member').on('cocoon:after-insert', function (e, committee_members) {
        var input_fields = committee_members.find('input.ldap-lookup');
        if (!input_fields.length) {
            return;
        }
...
var autocomplete_it = function autocomplete_it(input_fields) {
    var last_selected_ui = null;
...
var complete_email = function complete_email(ui, last_selected_ui, field_ref) {
...
initialize_alerts = function initialize_alerts() {

  if (!$('.alert-dismissable').length) {
    return;
  }

  $('.alert-dismissable').on('click', '.close', function () {
...
/* 41 */
/*!****************************************************!*\
  !*** ./app/javascript/base/collapse_indicators.js ***!
  \****************************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
initialize_collapse_indicators = function initialize_collapse_indicators() {

  var collapsible_content = $('.collapse');

  if (!collapsible_content.length) {
    return;
  }

  return collapsible_content.on('show.bs.collapse', function () {
    var content_id = '#' + $(this).attr('id');
    var indicator = $('[data-toggle="collapse"][data-target="' + content_id + '"] .hide-show-indicator');
...
/* 42 */
/*!***********************************************************!*\
  !*** ./app/javascript/base/display_first_nested_field.js ***!
  \***********************************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
initialize_nested_fields = function initialize_nested_fields() {

  var cocoon_link = $('.cocoon-links .add_fields');

  if (!cocoon_link.length) {
    return;
  }

  var fields = $('.nested-fields');
...
var initialize_layout = function initialize_layout() {
    ...
    var $footer = body_container.find('footer');

    var set_footer_margin = function set_footer_margin() {
...
var initialize_tagit = function initialize_tagit() {

    $('input.tagit').tagit({ allowSpaces: true });
    $('span.tagit-label').each(function (i, k) {
        var delete_msg = 'Delete keyword ' + k.textContent;
        var close_link = k.nextSibling;
    ...
    $('input.tagit').tagit({
        afterTagAdded: function afterTagAdded(event, ui) {
            var newlabel = 'Delete keyword ' + ui.tagLabel;
            var k = $('a.tagit-close').last();
    ...
    $('button#delete').on('keypress, click', function (e) {
        var tag_label = $('#ConfirmModal').data('taglabel');
        return $('input.tagit').tagit('removeTagByLabel', tag_label);
    });

    return $('#ConfirmModal').on('hidden.bs.modal', function (e) {
        return $('input.ui-widget-content').focus();
    });
};
...
$('.tagit-new input').on('keydown', function (e) {
    ...
    if (e.which === 9) {
        var next_item = $(this).closest('form').find(':input');
...
/* 45 */
/*!*********************************************!*\
  !*** ./app/javascript/base/toggle_caret.js ***!
  \*********************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
initialize_toggle_caret = function initialize_toggle_caret() {
  var pointer = $('#reports_menu').find('span');
  $('#reports_list').on('shown.bs.collapse', function () {
    return pointer.removeClass('caret-right');
  }).on('hidden.bs.collapse', function () {
    return pointer.addClass('caret-right');
  });
};
...
/* 46 */
/*!*****************************************************!*\
  !*** ./app/javascript/images/PS_HOR_REV_RGB_2C.png ***!
  \*****************************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "images/PS_HOR_REV_RGB_2C-68a4523658977bd9637d14490cfb0568.png";

/***/ })
/******/ ]);
//# sourceMappingURL=base-a441c8e2775fd58a1c6b.js.map