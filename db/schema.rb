...
ActiveRecord::Schema.define(version: 2021_01_27_184224) do
  ...
  create_table "approval_configurations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
  ...
  create_table "committee_member_tokens", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
  ...
  create_table "committee_members", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
  ...
  create_table "committee_roles", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
  ...
  create_table "degree_types", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.string "name", null: false
  ...
  create_table "final_submission_files", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.bigint "submission_id"
    t.text "asset"
    t.integer "legacy_id"
    t.datetime "created_at", null: false
  ...
  create_table "format_review_files", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.bigint "submission_id"
    t.text "asset"
    t.integer "legacy_id"
    t.datetime "created_at", null: false
  ...
  create_table "inbound_lion_path_records", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.bigint "author_id"
  ...
  create_table "invention_disclosures", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.bigint "submission_id"
    t.string "id_number"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "outbound_lion_path_records", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.text "status_data"
    t.boolean "received"
