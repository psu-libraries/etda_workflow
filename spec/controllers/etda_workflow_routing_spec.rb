...
RSpec.describe ActionDispatch::Routing, type: :controller do
  context 'admin routes' do
    ...
    #   expect(get: 'admin').to route_to(controller: 'admin/submissions', action: 'dashboard', degree_type: DegreeType.default.slug)
    ...
    #   expect(patch: 'admin/submissions/1/edit').to route_to(controller: 'admin/submissions', action: 'update', id: '1')
    #
    # end
