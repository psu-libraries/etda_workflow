RSpec.describe "when an admin views the final submission is pending bucket", js: true do
  ...
  let(:submission1) { FactoryBot.create :submission, :waiting_for_committee_review, author: author, semester: Semester.current.split(" ")[1], year: Semester.current.split(" ")[0] }
