RSpec.describe "Editing approval configuration", js: true do
  ...
  it 'has approval configuration content' do
    ...
    expect(page).to have_content('Require approval from head of graduate program after committee approval?')
  ...
  it 'updates changes applied by admin' do
    ...
    find('#approval_configuration_head_of_program_is_approving_false').click
    ...
    expect(ApprovalConfiguration.find(approval_configuration.id).head_of_program_is_approving).to eq false
