...
RSpec.describe SubmissionStates::CollectingFormatReviewFiles do
  ...
  describe 'name' do
    ...
    it { is_expected.to eq 'collecting format review files' }
  end

  describe 'status_date' do
    let(:submission) { FactoryBot.create :submission, :collecting_format_review_files }
