...
RSpec.describe SubmissionStates::CollectingFinalSubmissionFiles do
  describe 'instance methods' do
    ...
    it "transitions to Waiting For Committee Review" do
  ...
  describe 'name' do
    ...
    it { is_expected.to eq 'collecting final submission files' }
  end
  ...
  describe 'status_date' do
    ...
    it { is_expected.to eq(submission.format_review_approved_at) }
  end
