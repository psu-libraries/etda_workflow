...
RSpec.describe Submission, type: :model do
  ...
  describe '#check_title_capitalization' do
    it 'identifies all caps in the title' do
      ...
      expected_error = ActiveModel::Error.new(submission, :title, message: I18n.t('activerecord.errors.models.submission.attributes.title.capitalization'))
      expect(submission.check_title_capitalization).to eq(expected_error)
      expect(submission.errors[:title]).to eq([I18n.t('activerecord.errors.models.submission.attributes.title.capitalization')])
    end
