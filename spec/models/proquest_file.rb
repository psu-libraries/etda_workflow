...
RSpec.describe ProquestFile, type: :model do
  ...
  describe 'virus scanning' do
    ...
    let(:good_file) { FactoryBot.create :proquest_file }

    infected_file = ProquestFile.new(asset: File.open(fixture('eicar_standard_antivirus_test_file.pdf')))
