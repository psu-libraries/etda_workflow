...
RSpec.describe "Stoe 6: Waiting for Head of Program Review'", type: :request do
    ...
    context 'when author tries visiting various pages' do
      ...
      context "visiting the 'Update Program Information' page" do
        it "raises a forbidden access error" do
          ...
          submission = FactoryBot.create :submission, :waiting_for_head_of_program_review, author: author
