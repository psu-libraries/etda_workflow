...
class CommitteeMember < ApplicationRecord
  ...
  private
    ...
    def validate_federal_funding_used
      ...
      self.validation_message = (I18n.t('graduate.federal_funding_admin.error_message_2').html_safe if federal_funding_used && federal_funding_confirmation != 'true' && status == 'approved')
