...
class FormatReviewFile < ApplicationRecord
  ...
  validates :asset_cache, presence: true, if: proc { |f| !f.submission.nil? && f.submission.author_edit && f.submission.status_behavior.collecting_final_submission_files? }
