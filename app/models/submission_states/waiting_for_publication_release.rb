...
module SubmissionStates
  class WaitingForPublicationRelease < SubmissionState
    ...
    def initialize
      @transitions_to = [SubmissionStates::ReleasedForPublication, SubmissionStates::ReleasedForPublicationMetadataOnly, SubmissionStates::WaitingForFinalSubmissionResponse, SubmissionStates::WaitingInFinalSubmissionHold]
    end
