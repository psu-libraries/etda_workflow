json.array! [
  ...
  submission.semester_and_year.present? ? submission.semester_and_year : 'Date unknown', submission.admin_notes, submission.creation_date, submission.indicator_labels + submission.most_relevant_file_links.join(' ').html_safe
]
