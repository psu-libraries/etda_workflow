json.array! [
  ...
  submission_view.semester_and_year.presence || 'Date unknown', submission_view.admin_notes, submission_view.creation_date, submission_view.indicator_labels + submission_view.most_relevant_file_links.join(' ').html_safe
]
