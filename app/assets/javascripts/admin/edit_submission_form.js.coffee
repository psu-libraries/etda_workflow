setup_edit_submission_form = () ->
  ...
  $('#format-review-file-fields, #final-submission-file-fields')
    .on('cocoon:after-remove', (e,file)->
      $marked_for_deletion = $('<span class="marked-for-deletion text-danger"><i class="fa fa-exclamation-circle"></i> Marked for deletion </span>')
      $undo_delete = $('<a href="#">[undo]</a>')
      ...
      file.find('.file-link').addClass('danger')
    )
    .on('cocoon:undo-remove', (e,file)->
