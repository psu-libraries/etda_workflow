class FinalSubmissionSubmittedService
  attr_accessor :submission, :current_remote_user, :status_giver, :final_submission_params, :federal_funding_details_params

  def initialize(submission, current_remote_user, status_giver, final_submission_params, federal_funding_details_params = nil)
    @submission = submission
    @current_remote_user = current_remote_user
    @status_giver = status_giver
    @final_submission_params = final_submission_params
    @federal_funding_details_params = federal_funding_details_params
  end
  ...
  def final_submission_approved
    ...
    UpdateSubmissionService.admin_update_submission(submission, current_remote_user, final_submission_params, federal_funding_details_params)
