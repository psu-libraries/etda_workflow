...
class Admin::SubmissionFormView < SimpleDelegator
  ...
  def title
    ...
    return 'Edit Final Submission On Hold' if status_behavior.waiting_in_final_submission_hold?
  ...
  def actions_partial_name
    ...
    return 'on_hold_actions' if status_behavior.waiting_in_final_submission_hold?
  ...
  def form_for_url
    ...
    return "/admin/submissions/#{id}/update_waiting_to_be_released" if status_behavior.waiting_for_publication_release? || status_behavior.waiting_in_final_submission_hold?
  ...
  private
    ...
    def cancel_url
      ...
      return "/admin/#{degree_type.slug}/final_submission_on_hold" if status_behavior.waiting_in_final_submission_hold?
